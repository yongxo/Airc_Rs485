========================================================================
MICROSOFT 基础类库：Airc_Rs485 项目概述
========================================================================


应用程序向导已为您创建了此 Airc_Rs485 DLL。此 DLL 不仅
演示了 Microsoft 基础类的基本使用方法，还可
作为您编写 DLL 的起点。

此文件概述了组成 Airc_Rs485 DLL 的每个文件
的内容。
...
Airc_Rs485.cpp
这是主 DLL 源文件。它包含类 CAirc_Rs485App。

Airc_Rs485.rc
这是项目使用的所有 Microsoft Windows 资源的清单
。它包括存储在 RES 子目录中的图标、位图
和光标。如果 .rc 文件保持不变，数据节中的
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 Airc_Rs485.pch 的预编译头 (PCH) 文件
